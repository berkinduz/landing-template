export const siteContent = {
  "general": {
    ...
    "metadata": {
      ...
      "keywords": "fitness, gym, workout, health, training",
      "authors": [
        {
          "name": "Fitness Gym Team"
        }
      ],
      "openGraph": {
        "title": "Fitness Gym",
  ...
  "navigation": {
    ...
    "footer": {
      ...
      "brandDescription": "Transform your life through fitness. Join our community and achieve your goals.",
